...
export default function HeroSection() {
    return (
        <section id="home" className="relative">
            <Image src="https://res.cloudinary.com/djzt8qfjt/image/upload/q_auto,f_auto/v1731466816/hero-jpg_xfneoq.jpg" alt="hero" className="w-full h-screen object-cover" priority width={1920} height={1080} />
